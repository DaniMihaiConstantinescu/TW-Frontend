...
export default function AddImageModal({ stackId, handleClose }) {
      ...
      <div className={styles.contentContainer}>
        ...
        <form onSubmit={handleSubmit} className={styles.form}>
            <div className={styles.rowContainer}>
                <p className={styles.textLabel}>Image Name: </p>
                <TextField fullWidth="true" name="name" id="outlined-basic" size="small" variant="outlined" />
            </div>

            <div className={styles.rowContainer}>
                <p className={styles.textLabel}>Image description: </p>
                <Textarea
                    name="description"
                    style={{width: '100%'}}
                    minRows={7}
            ...
            <div className={styles.rowContainer}>
                <p className={styles.textLabel}>Image Location: </p>
